...
class _MealListScreenState extends State<MealListScreen> {
  ...
  // Charger tous les repas depuis la base de données
  ...
  // Calculer le total de calories du jour
  ...
  // Afficher une boîte de dialogue pour ajouter un repas
  ...
  // Couleur selon le type de repas
