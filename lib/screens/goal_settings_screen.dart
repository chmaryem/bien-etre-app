...
class GoalSettingsScreen extends StatefulWidget {
  final int userId; // ✅ AJOUT: Paramètre userId

  const GoalSettingsScreen({super.key, required this.userId}); // ✅ MODIF: Constructeur avec userId
...
class _GoalSettingsScreenState extends State<GoalSettingsScreen> {
  ...
  int get _currentUserId => widget.userId; // ✅ MODIF: Utiliser le userId passé en paramètre
